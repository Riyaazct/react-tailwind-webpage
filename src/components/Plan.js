    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p>
          ...
          saepe fugit laboriosam magnam corrupti in rerum quos
          quisquam fugiat doloremque dolore nisi veniam culpa
          molestiae tempora perspiciatis, distinctio eaque quo.
        </p>
        <div className="py-8 box">
          <button className="border-black hover:shadow-xl mx-2">
            Learn More
          </button>
          <button className="bg-black text-white border-black mx-2">
            Book Your Trip
          </button>
        </div>
      </div>
